...
This script recreates the functionality that was present in commit 12958b9 
but was removed in the subsequent cleanup commit.
"""
...
def main():
    ...
    if eval_metrics:
        ...
        print(f"Leave-One-Out Negative Log-Likelihood: {eval_metrics['loo_nll']:.2f}")
    ...
    # Plot 2: Evaluation metrics over trials (from iteration 3) - stacked vertically
    if eval_metrics:
    ...
    plt.tight_layout()
    plt.savefig('/home/runner/work/evaluation-metrics/evaluation-metrics/branin_campaign_demonstration_results.png', 
